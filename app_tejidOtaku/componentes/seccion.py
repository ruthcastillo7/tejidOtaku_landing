...
def seccion()->rx.Component:
  return rx.vstack(
      rx.hstack(
        ...
        rx.image(src="https://images.unsplash.com/photo-1686151676893-c788695bbc8a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGFtaWd1cnVtaXMlMjB5JTIwbGFuYXN8ZW58MHx8MHx8fDA%3D",width="500px"),
      ),
      rx.link(
